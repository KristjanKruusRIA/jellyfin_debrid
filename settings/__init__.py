...
settings_list = [
    ...
    [
        ...
        [
            ...
            setting(
                "Comet Base URL",
                "Please enter your Comet Base URL: ",
                _lazy_scraper_services.comet,
                "base_url",
                entry="parameter",
                help="Comet base URL (e.g., https://cometnet.elfhosted.com or your self-hosted instance)",
                hidden=True,
            ),
            setting(
                "Comet B64Config",
                "Please enter your Comet Base64 Config: ",
                _lazy_scraper_services.comet,
                "b64config",
                entry="parameter",
                help="Comet base64-encoded configuration extracted from your Comet URL (between domain and /manifest.json)",
                hidden=True,
            ),
        ],
    ],
