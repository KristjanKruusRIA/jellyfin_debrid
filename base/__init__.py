...
# set default regex version for the project
regex.DEFAULT_VERSION = regex.VERSION1

# Explicit re-exports for modules expecting these names from 'base'
__all__ = [
    "custom_session",
    "regex",
    "copy",
...
class custom_session(requests.Session):
    ...
    def post(self, url, data=None, json_data=None, **kwargs):
        ...
        Args:
            ...
            json_data (dict, optional): JSON data to send in the POST request.
            **kwargs: Additional keyword arguments to pass to the request.
